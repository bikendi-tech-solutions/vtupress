<?php
if(isset($_GET["vend"]) && $_GET["vend"]=="transfer" && vp_getoption('wallet_to_wallet') == "yes" && isset($level)){
if(strtolower($level[0]->transfer) == "yes" ){
				?>
...
<span class="input-group-text" id="basic-addon1">
                            ...
                            <input type="button" class="btn verify-user btn-secondary" value="Verify">
 </span>
</div>
...
<input type="button" name="fund_other" class="form-submit mb-2 btn-primary fund_other" value="Transfer"><br>
