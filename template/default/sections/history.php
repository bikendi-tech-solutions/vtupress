...
if(isset($_GET["vend"]) && $_GET["vend"]=="history" && isset($_GET["for"])){
	...
	<br>
		...
		<a href="?vend=history&for=transactions&type=data" class="pe-2 text-decoration-none"><button class="data-hist btn-sm btn-primary btn"><i class="mdi mdi-wifi "></i> >Bet Funding</button></a>
		';
