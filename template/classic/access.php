...
<head>
	...
	<!-- Site CSS -->
    <link rel="stylesheet" href="<?php echo vp_option_array($option_array,'siteurl').'/wp-content/plugins/vtupress/template/classic/csss/style.css';?>"> 
	<!-- Fontawesome CSS -->
...
<body>
<div id="particles-js" class="main-form-box shadow ">
	<div class="md-form">
		<div class="container">
			<div class="row">
				<div class="col-md-6 offset-md-3">
					<div class="panel panel-login">
						<div class="logo-top mb-4" style="#99999961;">
							<a href="<?php echo home_url();?>"><img src="<?php echo get_site_icon_url( 75, vp_option_array($option_array,'siteurl').'/wp-content/plugins/vtupress/images/login.png');?>" alt="" style="height:75px; width:75px;"/></a>
						</div>
						<div class="panel-heading shadow ">
							<div class="row">
								<div class="col-lg-6 col-sm-6 col-xl-6">
									<a href="#" class="active shadow " id="login-form-link">Login</a>
								</div>
								<div class="col-lg-6 col-sm-6 col-xl-6">
									<a href="#" id="register-form-link" class="shadow " >Register</a>
								</div>
								<div class="or">OR</div>
							</div>
						</div>
							...
							<div class="row">
								<div class="col-lg-12">
									...
									<form id="login-form" method="post" role="form" class="loginit" style="display: block;">
										...
										<div class="form-group">
											<label class="icon-lp mr-3"><i class="fa fa-eye dpass" aria-hidden="true"></i></label>
										...
										<div class="form-group">
											<div class="row">
												<div class="col-sm-6 offset-sm-3">
													<input type="button" role="button" name="vplogin" id="login-submit" tabindex="4" class="form-control btn btn-login shadow rounded w-10 loginow" value="Log In">
												</div>
											</div>
										</div>
											...
											<div class="row">
												<div class="col-lg-12">
													<div class="text-center">
														<a href="#" tabindex="5" class="forgot-password shadow w-100">Forgot Password?</a>
													</div>
												</div>
											</div>
										</div>
									...
									<form id="register-form" method="post" class="signup" role="form" style="display: none;">
										...
										<div class="form-group">
											<label class="icon-lp mr-3"><i class="fas fa-phone"></i></label>
											<input type="number" name="phone" id="username" tabindex="1" class="form-control phone" placeholder="Phone" value="" required="">
										</div>
										<div class="form-group">
											<label class="icon-lp mr-3"><i class="fas fa-envelope"></i></label>
										...
										<div class="form-group">
											<div class="row">
												<div class="col-sm-6 offset-sm-3">
													<input type="button" role="button" name="register-submit" id="register-submit" tabindex="4" class="form-control btn btn-register shadow rounded w-100 registernow" value="Register Now">
												</div>
											</div>
										</div>										
									</form>
