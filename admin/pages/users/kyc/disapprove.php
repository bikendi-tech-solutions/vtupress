...
<div class="card">
                <div class="card-body">
                  <h5 class="card-title">Disapproved Users</h5>

                  <?php

    pagination_kyc_before("WHERE status = 'retry'");
...
?>
    ...
    <td colspan="8">No User Disapproved</td>
    </tr>
<?php
}else{
...
foreach($users as $users){
  ...
  <td>
<button type='button' class='btn btn-secondary' onclick='approve(\"$users->user_id\",\"$doc\");' doc='$doc'>Approve</button>
<button type='button' class='btn btn-secondary' onclick='ban(\"$users->user_id\",\"$doc\");' doc='$doc'>Ban</button>
...
function ban(user,doc){

if(confirm("Do You Want To Ban This User's Submission? \n S(he) won't be able to make another submission!") == true){
...
function approve(user,doc){

if(confirm("Do You Really Want To Approve This User?") == true){
