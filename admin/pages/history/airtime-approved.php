...
<div class="card">
                <div class="card-body">
                  <h5 class="card-title">Approved Airtime Conversion</h5>

                  <?php

if(!isset($_GET["trans_id"])){
    pagination_conversion_before("false");
}
elseif(empty($_GET["trans_id"])){
    ...
    if(is_numeric($_GET["trans_id"])){
        $id = $_GET["trans_id"];
        pagination_conversion_before("false","AND id = '$id'");
    }
    else{
        pagination_conversion_before("false");
    }
...
?>
    ...
    <td colspan="8">No Conversion Approved</td>
    </tr>
<?php
}else{
