                ...
                <div class="row">
                  ...
                  <div class="col vtu_airtime">
                    ...
                    <select name="vtu_airtime_select" class="vtu_airtime_select">
                      <option value="<?php echo vp_option_array($option_array, "vtu_airtime_platform"); ?>">
                        <?php echo vp_option_array($option_array, "vtu_airtime_platform"); ?></option>

                      <?php
                      $url = "https://vtupress.com/wp-content/plugins/vpimporter/vpimporter.php?vtu_names&country=" . $country;
                  ...
                  <?php if(!$bypass):?>
                    <div class="col share_airtime">
                      ...
                      <select name="share_airtime_select" class="share_airtime_select">
                        <option value="<?php echo vp_option_array($option_array, "share_airtime_platform"); ?>">
                          <?php echo vp_option_array($option_array, "share_airtime_platform"); ?></option>

                        <?php
                        $url = "https://vtupress.com/wp-content/plugins/vpimporter/vpimporter.php?share_names&country=" . $country;
                    ...
                    <div class="col awuf_airtime">
                      ...
                      <select name="awuf_airtime_select" class="awuf_airtime_select">
                        <option value="<?php echo vp_option_array($option_array, "awuf_airtime_platform"); ?>">
                          <?php echo vp_option_array($option_array, "awuf_airtime_platform"); ?></option>

                        <?php
                        $url = "https://vtupress.com/wp-content/plugins/vpimporter/vpimporter.php?awuf_names&country=" . $country;
