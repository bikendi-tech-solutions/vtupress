...
<div class="card">
                <div class="card-body">
                  <h5 class="card-title">SMS IMPORTER</h5> 
...
jQuery("#cover-spin").hide();
var select = jQuery(".sms_select option:selected").text();
	swal({
  title: "Error",
  text: jQuery(".sms_select option:selected").text()+" Importer Doesn\'t Exist  For This Service",
  icon: "error",
  button: "Okay",
});	  
	  }
