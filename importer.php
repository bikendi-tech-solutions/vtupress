...
if (vp_getoption("vp_access_importer") == "yes") {
	if (isset($_REQUEST["vtu_airtime_import"])) {
		...
		$response = vp_get_contents("https://vtupress.com/wp-content/plugins/vpimporter/vpimporter.php?country=$country&vtu_airtime_import=$vtu_airtime_select");
				...
				switch ($key) {
					...
					case "postdata5":
						...
						break;
											case "postdata6":
						foreach ($value as $key2 => $value2) {
							vp_updateoption("airtimepostdata6", "$key2");
							vp_updateoption("airtimepostvalue6", "$value2");
						}
						break;
											case "postdata7":
						foreach ($value as $key2 => $value2) {
							vp_updateoption("airtimepostdata7", "$key2");
							vp_updateoption("airtimepostvalue7", "$value2");
						}
						break;
											case "postdata8":
						foreach ($value as $key2 => $value2) {
							vp_updateoption("airtimepostdata8", "$key2");
							vp_updateoption("airtimepostvalue8", "$value2");
						}
						break;
					case "amountattr":
		...
		$response = vp_get_contents("https://vtupress.com/wp-content/plugins/vpimporter/vpimporter.php?country=$country&share_airtime_import=$share_airtime_select");
		$json = json_decode($response, true);
				...
				switch ($key) {
					...
					case "postdata5":
						...
						break;
											case "postdata6":
						foreach ($value as $key2 => $value2) {
							vp_updateoption("sairtimepostdata6", "$key2");
							vp_updateoption("sairtimepostvalue6", "$value2");
						}
						break;
											case "postdata7":
						foreach ($value as $key2 => $value2) {
							vp_updateoption("sairtimepostdata7", "$key2");
							vp_updateoption("sairtimepostvalue7", "$value2");
						}
						break;
											case "postdata8":
						foreach ($value as $key2 => $value2) {
							vp_updateoption("sairtimepostdata8", "$key2");
							vp_updateoption("sairtimepostvalue8", "$value2");
						}
						break;
					case "amountattr":
		...
		$response = vp_get_contents("https://vtupress.com/wp-content/plugins/vpimporter/vpimporter.php?country=$country&awuf_airtime_import=$awuf_airtime_select");
		$json = json_decode($response, true);
				...
				switch ($key) {
					...
					case "postdata5":
						...
						break;
											case "postdata5":
						foreach ($value as $key2 => $value2) {
							vp_updateoption("wairtimepostdata6", "$key2");
							vp_updateoption("wairtimepostvalue6", "$value2");
						}
						break;
											case "postdata7":
						foreach ($value as $key2 => $value2) {
							vp_updateoption("wairtimepostdata7", "$key2");
							vp_updateoption("wairtimepostvalue7", "$value2");
						}
						break;
											case "postdata8":
						foreach ($value as $key2 => $value2) {
							vp_updateoption("wairtimepostdata8", "$key2");
							vp_updateoption("wairtimepostvalue8", "$value2");
						}
						break;
					case "amountattr":
		...
		$response = vp_get_contents("https://vtupress.com/wp-content/plugins/vpimporter/vpimporter.php?country=$country&sme_data_import=$sme_data_select");
		$json = json_decode($response, true);
				...
				switch ($key) {
					...
					case "postdata5":
						...
						break;
											case "postdata6":
						foreach ($value as $key2 => $value2) {
							vp_updateoption("datapostdata6", "$key2");
							vp_updateoption("datapostvalue6", "$value2");
						}
						break;
											case "postdata7":
						foreach ($value as $key2 => $value2) {
							vp_updateoption("datapostdata7", "$key2");
							vp_updateoption("datapostvalue7", "$value2");
						}
						break;
											case "postdata8":
						foreach ($value as $key2 => $value2) {
							vp_updateoption("datapostdata8", "$key2");
							vp_updateoption("datapostvalue8", "$value2");
						}
						break;
					case "amountattr":
		...
		$response = vp_get_contents("https://vtupress.com/wp-content/plugins/vpimporter/vpimporter.php?country=$country&smile_data_import=$smile_data_select");
		$json = json_decode($response, true);
				...
				switch ($key) {
					...
					case "postdata5":
						...
						break;
											case "postdata6":
						foreach ($value as $key2 => $value2) {
							vp_updateoption("smilepostdata6", "$key2");
							vp_updateoption("smilepostvalue6", "$value2");
						}
						break;
											case "postdata7":
						foreach ($value as $key2 => $value2) {
							vp_updateoption("smilepostdata7", "$key2");
							vp_updateoption("smilepostvalue7", "$value2");
						}
						break;
											case "postdata8":
						foreach ($value as $key2 => $value2) {
							vp_updateoption("smilepostdata8", "$key2");
							vp_updateoption("smilepostvalue8", "$value2");
						}
						break;
					case "amountattr":
		...
		$response = vp_get_contents("https://vtupress.com/wp-content/plugins/vpimporter/vpimporter.php?country=$country&bet_import=$bet_select");
		$json = json_decode($response, true);
				...
				switch ($key) {
					...
					case "postdata5":
						...
						break;
											case "postdata6":
						foreach ($value as $key2 => $value2) {
							vp_updateoption("betpostdata6", "$key2");
							vp_updateoption("betpostvalue6", "$value2");
						}
						break;
											case "postdata7":
						foreach ($value as $key2 => $value2) {
							vp_updateoption("betpostdata7", "$key2");
							vp_updateoption("betpostvalue7", "$value2");
						}
						break;
											case "postdata8":
						foreach ($value as $key2 => $value2) {
							vp_updateoption("betpostdata8", "$key2");
							vp_updateoption("betpostvalue8", "$value2");
						}
						break;
					case "amountattr":
		...
		$response = vp_get_contents("https://vtupress.com/wp-content/plugins/vpimporter/vpimporter.php?country=$country&alpha_data_import=$alpha_data_select");
		$json = json_decode($response, true);
				...
				switch ($key) {
					...
					case "postdata5":
						...
						break;
											case "postdata6":
						foreach ($value as $key2 => $value2) {
							vp_updateoption("alphapostdata6", "$key2");
							vp_updateoption("alphapostvalue6", "$value2");
						}
						break;
											case "postdata7":
						foreach ($value as $key2 => $value2) {
							vp_updateoption("alphapostdata7", "$key2");
							vp_updateoption("alphapostvalue7", "$value2");
						}
						break;
											case "postdata8":
						foreach ($value as $key2 => $value2) {
							vp_updateoption("alphapostdata8", "$key2");
							vp_updateoption("alphapostvalue8", "$value2");
						}
						break;
					case "amountattr":
		...
		$response = vp_get_contents("https://vtupress.com/wp-content/plugins/vpimporter/vpimporter.php?country=$country&direct_data_import=$direct_data_select");
		$json = json_decode($response, true);
		...
		if ($json["available"] == "yes") {
			foreach ($json as $key => $value) {
				switch ($key) {
					...
					case "postdata6":
						foreach ($value as $key2 => $value2) {
							vp_updateoption("rdatapostdata6", "$key2");
							vp_updateoption("rdatapostvalue6", "$value2");
						}
						break;
					case "postdata7":
						foreach ($value as $key2 => $value2) {
							vp_updateoption("rdatapostdata7", "$key2");
							vp_updateoption("rdatapostvalue7", "$value2");
						}
						break;
					case "postdata8":
						foreach ($value as $key2 => $value2) {
							vp_updateoption("rdatapostdata8", "$key2");
							vp_updateoption("rdatapostvalue8", "$value2");
						}
						break;
					case "amountattr":
		...
		$response = vp_get_contents("https://vtupress.com/wp-content/plugins/vpimporter/vpimporter.php?country=$country&corporate_data_import=$corporate_data_select");
		$json = json_decode($response, true);
				...
				switch ($key) {
					...
					case "postdata5":
						...
						break;
											case "postdata6":
						foreach ($value as $key2 => $value2) {
							vp_updateoption("r2datapostdata6", "$key2");
							vp_updateoption("r2datapostvalue6", "$value2");
						}
						break;
											case "postdata7":
						foreach ($value as $key2 => $value2) {
							vp_updateoption("r2datapostdata7", "$key2");
							vp_updateoption("r2datapostvalue7", "$value2");
						}
						break;
											case "postdata8":
						foreach ($value as $key2 => $value2) {
							vp_updateoption("r2datapostdata8", "$key2");
							vp_updateoption("r2datapostvalue8", "$value2");
						}
						break;
					case "amountattr":
		...
		$response = vp_get_contents("https://vtupress.com/wp-content/plugins/vpimporter/vpimporter.php?country=$country&cable_import=$cable_select");
		$json = json_decode($response, true);
				...
				switch ($key) {
					...
					case "postdata5":
						...
						break;
											case "postdata6":
						foreach ($value as $key2 => $value2) {
							vp_updateoption("cablepostdata6", "$key2");
							vp_updateoption("cablepostvalue6", "$value2");
						}
						break;
											case "postdata7":
						foreach ($value as $key2 => $value2) {
							vp_updateoption("cablepostdata7", "$key2");
							vp_updateoption("cablepostvalue7", "$value2");
						}
						break;
											case "postdata8":
						foreach ($value as $key2 => $value2) {
							vp_updateoption("cablepostdata8", "$key2");
							vp_updateoption("cablepostvalue8", "$value2");
						}
						break;
					case "typeattr":
		...
		$response = vp_get_contents("https://vtupress.com/wp-content/plugins/vpimporter/vpimporter.php?country=$country&bill_import=$bill_select");
		$json = json_decode($response, true);
				...
				switch ($key) {
					...
					case "postdata5":
						...
						break;
											case "postdata6":
						foreach ($value as $key2 => $value2) {
							vp_updateoption("billpostdata6", "$key2");
							vp_updateoption("billpostvalue6", "$value2");
						}
						break;
											case "postdata7":
						foreach ($value as $key2 => $value2) {
							vp_updateoption("billpostdata7", "$key2");
							vp_updateoption("billpostvalue7", "$value2");
						}
						break;
											case "postdata8":
						foreach ($value as $key2 => $value2) {
							vp_updateoption("billpostdata8", "$key2");
							vp_updateoption("billpostvalue8", "$value2");
						}
						break;
					case "typeattr":
		...
		$response = vp_get_contents("https://vtupress.com/wp-content/plugins/vpimporter/vpimporter.php?country=$country&sms_import=$sms_select");
		$json = json_decode($response, true);
				...
				switch ($key) {
					...
					case "postdata5":
						...
						break;
											case "postdata6":
						foreach ($value as $key2 => $value2) {
							vp_updateoption("smspostdata6", "$key2");
							vp_updateoption("smspostvalue6", "$value2");
						}
						break;
											case "postdata7":
						foreach ($value as $key2 => $value2) {
							vp_updateoption("smspostdata7", "$key2");
							vp_updateoption("smspostvalue7", "$value2");
						}
						break;
											case "postdata8":
						foreach ($value as $key2 => $value2) {
							vp_updateoption("smspostdata8", "$key2");
							vp_updateoption("smspostvalue8", "$value2");
						}
						break;
					case "message":
